...
/*
 * go to the 'url' if the browser is not a browser for mobile.
 * mobileOrNot - Mark if it should be mobile or not. (true = moblie, false = not mobile).
*/
function check_browser(url, mobileOrNot){
