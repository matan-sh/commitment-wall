...
function send_data(lan){
	...
	if(firstName === emptyStr || lastName === emptyStr || mail === emptyStr){
		...
		if(!aprov){
			...
			*/
			if(lan === "Hebrew")
				url += "?lan=He?fn="+firstName+"?ln="+lastName+"?em="+mail;
			else if(lan === "English")
				url += "?lan=En?fn="+firstName+"?ln="+lastName+"?em="+mail;
			else if(lan === "Arabic")
				url += "?lan=Ar?fn="+firstName+"?ln="+lastName+"?em="+mail;
