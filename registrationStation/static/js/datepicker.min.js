    ...
    e.Datepicker = "",
        function() {
            ...
            Datepicker = function(e, a) {
                ...
                _defineLocale: function(e) {
                    "string" == typeof e ? (this.loc = Datepicker.language[e], this.loc || (console.warn("Can't find language \"" + e + '" in Datepicker.language, will use "ru" instead'), this.loc = t.extend(!0, {}, Datepicker.language.en)), this.loc = t.extend(!0, {}, Datepicker.language.en, Datepicker.language[e])) : this.loc = t.extend(!0, {}, Datepicker.language.en, e), this.opts.dateFormat && (this.loc.dateFormat = this.opts.dateFormat), "" !== this.opts.firstDay && (this.loc.firstDay = this.opts.firstDay)
                },
                ...
                formatDate: function(e, t) {
                    ...
                    switch (!0) {
                        ...
                        case /dd/.test(s):
                            s = s.replace(i("dd"), o.fullDate);
                        case /d/.test(s):
                            s = s.replace(i("d"), o.date);
                        case /DD/.test(s):
                            s = s.replace(i("DD"), a.days[o.day]);
                        case /D/.test(s):
                            s = s.replace(i("D"), a.daysShort[o.day]);
                        case /mm/.test(s):
                            s = s.replace(i("mm"), o.fullMonth);
                        case /m/.test(s):
                            s = s.replace(i("m"), o.month + 1);
                        case /MM/.test(s):
                            s = s.replace(i("MM"), this.loc.months[o.month]);
                        case /M/.test(s):
                            s = s.replace(i("M"), a.monthsShort[o.month]);
                        case /yyyy/.test(s):
                            s = s.replace(i("yyyy"), o.year);
                        case /yyyy1/.test(s):
                            s = s.replace(i("yyyy1"), h[0]);
                        case /yyyy2/.test(s):
                            s = s.replace(i("yyyy2"), h[1]);
                        case /yy/.test(s):
                            s = s.replace(i("yy"), o.year.toString().slice(-2))
                    }
                    return s
                },
                ...
                _isInRange: function(e, t) {
                    var s = e.getTime(),
                        ...
                        o = new Date(i.year, i.month, a.date).getTime(),
                        r = new Date(i.year, i.month, h.date).getTime(),
                        c = {
                ...
                _getDateFromCell: function(e) {
                    var t = this.parsedDate,
                        ...
                        a = e.data("month") == s ? t.month : e.data("month"),
                        n = e.data("date") || 1;
                ...
                _handleHotKey: function(e) {
                    var t, s, i, a = n.getParsedDate(this._getFocusedDate()),
                        h = this.opts,
                        o = !1,
                        r = !1,
                        c = !1,
                ...
                _focusNextCell: function(e, t) {
                    t = t || this.cellType;
                    var s = n.getParsedDate(this._getFocusedDate()),
                        i = s.year,
                        a = s.month,
                        h = s.date;
                ...
                _getCell: function(e, t) {
                    t = t || this.cellType;
                    var s, i = n.getParsedDate(e),
                        a = '.datepicker--cell[data-year="' + i.year + '"]';
                    switch (t) {
                        case "month":
        ...
        function() {
            ...
            i.Body = function(e, t, s) {
                ...
                _getDayNamesHtml: function(e, t, i, a) {
                    return t = t != s ? t : e, i = i ? i : "", a = a != s ? a : 0, a > 7 ? i : 7 == t ? this._getDayNamesHtml(e, 0, i, ++a) : (i += '<div class="datepicker--day-name' + (this.d.isWeekend(t) ? " -weekend-" : "") + '">' + this.d.loc.daysMin[t] + "</div>", this._getDayNamesHtml(e, ++t, i, ++a))
                },
                _getCellContents: function(e, t) {
                    var s = "datepicker--cell datepicker--cell-" + t,
                        a = new Date,
                        n = this.d,
                        h = n.opts,
                        o = i.getParsedDate(e),
                        r = {},
                        c = o.date;
                    switch (h.onRenderCell && (r = h.onRenderCell(e, t) || {}, c = r.html ? r.html : c, s += r.classes ? " " + r.classes : ""), t) {
                        case "day":
                            n.isWeekend(o.day) && (s += " -weekend-"), o.month != this.d.parsedDate.month && (s += " -other-month-", h.selectOtherMonths || (s += " -disabled-"), h.showOtherMonths || (c = ""));
                            break;
                        case "month":
                            c = n.loc[n.opts.monthsField][o.month];
                            break;
                        case "year":
                            var d = n.curDecade;
                            c = o.year, (o.year < d[0] || o.year > d[1]) && (s += " -other-decade-", h.selectOtherYears || (s += " -disabled-"), h.showOtherYears || (c = ""))
                    }
                    return h.onRenderCell && (r = h.onRenderCell(e, t) || {}, c = r.html ? r.html : c, s += r.classes ? " " + r.classes : ""), h.range && (i.isSame(n.minRange, e, t) && (s += " -range-from-"), i.isSame(n.maxRange, e, t) && (s += " -range-to-"), 1 == n.selectedDates.length && n.focused ? ((i.bigger(n.minRange, e) && i.less(n.focused, e) || i.less(n.maxRange, e) && i.bigger(n.focused, e)) && (s += " -in-range-"), i.less(n.maxRange, e) && i.isSame(n.focused, e) && (s += " -range-from-"), i.bigger(n.minRange, e) && i.isSame(n.focused, e) && (s += " -range-to-")) : 2 == n.selectedDates.length && i.bigger(n.minRange, e) && i.less(n.maxRange, e) && (s += " -in-range-")), i.isSame(a, e, t) && (s += " -current-"), n.focused && i.isSame(e, n.focused, t) && (s += " -focus-"), n._isSelected(e, t) && (s += " -selected-"), (!n._isInRange(e, t) || r.disabled) && (s += " -disabled-"), {
                        html: c,
                        classes: s
                    }
                },
                _getDaysHtml: function(e) {
                    var t = i.getDaysCount(e),
                        s = new Date(e.getFullYear(), e.getMonth(), 1).getDay(),
                        a = new Date(e.getFullYear(), e.getMonth(), t).getDay(),
                        n = s - this.d.loc.firstDay,
                        h = 6 - a + this.d.loc.firstDay;
                    n = 0 > n ? n + 7 : n, h = h > 6 ? h - 7 : h;
                    for (var o, r, c = -n + 1, d = "", l = c, u = t + h; u >= l; l++) r = e.getFullYear(), o = e.getMonth(), d += this._getDayHtml(new Date(r, o, l));
                    return d
                },
                ...
                _getMonthsHtml: function(e) {
                    for (var t = "", s = i.getParsedDate(e), a = 0; 12 > a;) t += this._getMonthHtml(new Date(s.year, a)), a++;
                    return t
                },
                ...
                _getYearsHtml: function(e) {
                    var t = (i.getParsedDate(e), i.getDecade(e)),
                        s = t[0] - 1,
                        a = "",
                        n = s;
                    for (n; n <= t[1] + 1; n++) a += this._getYearHtml(new Date(n, 0));
                    return a
                },
                ...
                _update: function() {
                    var e, s, i, a = t(".datepicker--cell", this.$cells),
                        n = this;
                    a.each(function(a, h) {
                        s = t(this), i = n.d._getDateFromCell(t(this)), e = n._getCellContents(i, n.d.cellType), s.attr("class", e.classes)
                    })
                },
                show: function() {
                ...
                _handleClick: function(e) {
                    ...
                    var a = new Date(i, s, t),
                        n = this.d._isSelected(a, this.d.cellType);
                    n ? n && this.opts.toggleSelected && this.d.removeDate(a) : this.d.selectDate(a)
                },
                _onClickCell: function(e) {
                    var s = t(e.target).closest(".datepicker--cell");
                    s.hasClass("-disabled-") || this._handleClick.bind(this)(s)
                }
            }
        }(),
        function() {
            var e = '<div class="datepicker--nav-action" data-action="prev">#{prevHtml}</div><div class="datepicker--nav-title">#{title}</div><div class="datepicker--nav-action" data-action="next">#{nextHtml}</div>',
                ...
                i = '<span class="datepicker--button" data-action="#{action}">#{label}</span>';
            Datepicker.Navigation = function(e, t) {
                ...
                _render: function() {
                    var s = this._getTitle(this.d.currentDate),
                        i = Datepicker.template(e, t.extend({
                            title: s
                        }, this.opts));
                ...
                _onClickNavButton: function(e) {
                    var s = t(e.target).closest("[data-action]"),
                        i = s.data("action");
                    this.d[i]()
                },
