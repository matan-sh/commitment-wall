        ...
        _defineLocale: function (lang) {
            if (typeof lang == 'string') {
                ...
                if (!this.loc) {
                    ...
                    this.loc = $.extend(true, {}, Datepicker.language.en)
                }

                this.loc = $.extend(true, {}, Datepicker.language.en, Datepicker.language[lang])
            } else {
                this.loc = $.extend(true, {}, Datepicker.language.en, lang)
            }
